...
TERMUX_PKG_MAINTAINER="@droidv1"
TERMUX_PKG_VERSION=1.0.0
TERMUX_PKG_SRCURL=https://github.com/droidv1/pymaker/releases/download/{$TERMUX_PKG_VERSION}/pymaker-{$TERMUX_PKG_VERSION}.tar.gz
